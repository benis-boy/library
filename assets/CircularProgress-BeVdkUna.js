var Ke=Object.defineProperty;var Ye=(e,t,r)=>t in e?Ke(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var Y=(e,t,r)=>Ye(e,typeof t!="symbol"?t+"":t,r);import{ae as Ee,af as Ge,r as c,ag as He,ah as me,ai as Je,aj as Ze,ak as Qe,al as et,am as tt,an as rt,ao as nt,ap as ot,R as Z,aq as ye,c as T,j as I,a as le,u as ue,s as z,g as $e,A as ge,D as Q,d as Te,b as ee,m as we}from"./index-BF6WfBJV.js";var ne={exports:{}},m={};/** @license React v16.13.1
...
`,Ft=typeof ie!="string"?ce`
      ...
      `:null,Lt=e=>{const{classes:t,variant:r,color:a,disableShrink:i}=e,o={root:["root",r,`color${ee(a)}`],svg:["svg"],circle:["circle",`circle${ee(r)}`,i&&"circleDisableShrink"]};return Te(o,Vt,t)},_t=z("span",{name:"MuiCircularProgress",slot:"Root",overridesResolver:(e,t)=>{const{ownerState:r}=e;return[t.root,t[r.variant],t[`color${ee(r.color)}`]]}})(we(({theme:e})=>({display:"inline-block",variants:[{props:{variant:"determinate"},style:{transition:e.transitions.create("transform")}},{props:{variant:"indeterminate"},style:Ft||{animation:`${ie} 1.4s linear infinite`}},...Object.entries(e.palette).filter(Ot()).map(([t])=>({props:{color:t},style:{color:(e.vars||e).palette[t].main}}))]}))),Bt=z("svg",{name:"MuiCircularProgress",slot:"Svg",overridesResolver:(e,t)=>t.svg})({display:"block"}),zt=z("circle",{name:"MuiCircularProgress",slot:"Circle",overridesResolver:(e,t)=>{const{ownerState:r}=e;return[t.circle,t[`circle${ee(r.variant)}`],r.disableShrink&&t.circleDisableShrink]}})(we(({theme:e})=>({stroke:"currentColor",variants:[{props:{variant:"determinate"},style:{transition:e.transitions.create("stroke-dashoffset")}},{props:{variant:"indeterminate"},style:{strokeDasharray:"80px, 200px",strokeDashoffset:0}},{props:({ownerState:t})=>t.variant==="indeterminate"&&!t.disableShrink,style:At||{animation:`${ae} 1.4s ease-in-out infinite`}}]}))),Yt=c.forwardRef(function(t,r){const a=ue({props:t,name:"MuiCircularProgress"}),{className:i,color:o="primary",disableShrink:s=!1,size:u=40,style:l,thickness:p=3.6,value:y=0,variant:g="indeterminate",...R}=a,S={...a,color:o,disableShrink:s,size:u,thickness:p,value:y,variant:g},h=Lt(S),M={},x={},C={};if(g==="determinate"){const E=2*Math.PI*((A-p)/2);M.strokeDasharray=E.toFixed(3),C["aria-valuenow"]=Math.round(y),M.strokeDashoffset=`${((100-y)/100*E).toFixed(3)}px`,x.transform="rotate(-90deg)"}return I.jsx(_t,{className:T(h.root,i),style:{width:u,height:u,...x,...l},ownerState:S,ref:r,role:"progressbar",...C,...R,children:I.jsx(Bt,{className:h.svg,ownerState:S,viewBox:`${A/2} ${A/2} ${A} ${A}`,children:I.jsx(zt,{className:h.circle,style:M,ownerState:S,cx:A,cy:A,r:(A-p)/2,fill:"none",strokeWidth:p})})})});export{Kt as B,Yt as C,Xt as G,pt as a,Ot as c,Ce as i,Wt as u};
